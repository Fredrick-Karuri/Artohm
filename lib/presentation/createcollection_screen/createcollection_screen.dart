        ...
        child: Scaffold(
            ...
            appBar: CustomAppBar(
                ...
                title: AppbarSubtitle(
                    ...
                    margin:
                        EdgeInsets.only(left: 36.h, top: 34.v, bottom: 4.v)),
                actions: [
                  AppbarImage1(
                      svgPath: ImageConstant.imgMask,
                      margin:
                          EdgeInsets.only(left: 9.h, right: 9.h, bottom: 49.v))
                ]),
            body: Container(
                                        ...
                                        child: SizedBox(
                                            ...
                                            child: Obx(() => ListView.separated(
                                                ...
                                                itemBuilder: (context, index) {
                                                  SelectartworkItemModel model =
                                                      controller
                                                          .createcollectionModelObj
                                                          .value
                                                          .selectartworkItemList
                                                          .value[index];
                                                  return SelectartworkItemWidget(
                                                      model);
                                                }))))
                                  ]))))
                ])),
